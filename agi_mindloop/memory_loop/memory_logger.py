...
class MemoryLogger:
    """
    Simple JSONL logger for pre-memory buffering of system events.
    Each line is a JSON object with keys: timestamp, event_type, data, source_module.
    ...
    def log(self, event_type: str, data: Dict[str, Any], source_module: str) -> None:
        entry = {
            "timestamp": _now_iso(),
